...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("OrderItemObjectPageObjectPage journey");

        opaTest("Navigate to OrderItemObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheOrderObjectPage.onTable({ property: "orderItem" }).iCheckRows();
            When.onTheOrderObjectPage.onTable({ property: "orderItem" }).iPressRow(0);

            Then.onTheOrderItemObjectPage.iSeeThisPage();
        });
