...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "samp/fiorisample/test/integration/FirstJourney",
    "samp/fiorisample/test/integration/OrderListJourney",
    "samp/fiorisample/test/integration/OrderObjectPageJourney",
    "samp/fiorisample/test/integration/OrderItemObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
